...
fm.websync.webSocket = (function() {
  ...
  webSocket.prototype.open = function(args) {
    ...
    if ('WebSocket' in window) {
      this._webSocket = new WebSocket(this._requestUrl);
    } else if ('MozWebSocket' in window) {
      this._webSocket = new MozWebSocket(this._requestUrl);
    }
    if (!this._webSocket) {
...
/**
@class fm.websync.backoffAlgorithm
 <div>
 Various algorithms for use in calculating backoff intervals.
 </div>

@extends fm.enum
*/

fm.websync.backoffAlgorithm = {
  /**
  	@type {fm.websync.backoffAlgorithm}
  	@description  <div>
  	 Indicates that the backoff interval should increase
  	 by a pre-specified interval with each attempt.
  	 </div>
  */
  ...
  /**
  	@type {fm.websync.backoffAlgorithm}
  	@description  <div>
  	 Indicates that the backoff interval should remain at
  	 a pre-specified interval for each attempt.
  	 </div>
  */
  ...
  /**
  	@type {fm.websync.backoffAlgorithm}
  	@description  <div>
  	 Indicates that the backoff interval should double with
  	 each attempt, starting with a pre-specified interval.
  	 </div>
  */
  ...
  /**
  	@type {fm.websync.backoffAlgorithm}
  	@description  <div>
  	 Indicates that each attempt should be started
  ...
  */
  ...
  /**
  	@type {fm.websync.backoffAlgorithm}
  	@description  <div>
  	 Same as <see cref="fm.websync.backoffAlgorithm.Exponential">fm.websync.backoffAlgorithm.Exponential</see>.
  	 </div>
  */
...
fm.websync.webSocketTransfer = (function(_super) {
  ...
  */
  ...
  function webSocketTransfer() {
    ...
    requestUrl = requestUrl.replace("https://", "ws://");
...
fm.websync.baseClient = (function(_super) {
  ...
  */
  ...
  /**
  	 <div>
  	 Takes a domain name and ensures it starts with https:// or https://.
...
fm.websync.client = (function(_super) {
  ...
  */
  ...
  /**
  	 ...
  	 </div><returns>A list of all the channels to which the client is currently subscribed</returns>
  ...
  */
  ...
  client.prototype.receiveMessage = function() {
    var dictionary, dictionary2, dictionary3, i, list, list2, list3, message, onNotify, onReceive, str, str2, _i, _j, _k, _l, _len, _len1, _len2, _len3, _results, _var0, _var1, _var2, _var3, _var4, _var5, _var6, _var7, _var8;
    message = arguments[0];
    if (message.getBayeuxChannel() === "/meta/notify") {
      ...
      while (i < fm.arrayExtensions.getCount(list)) {
        ...
        this.raiseSubscribeDelivery(onReceive, dictionary3, message);
        _results.push(i++);
      }
      return _results;
    }
  ...
  */
  ...
  client.prototype.sendCallback = function() {
    var advice, args2, dynamicValue, list, longPolling, message, message2, onReceive, p, request, responseArgs, serverActions, _i, _j, _len, _len1, _results, _var0, _var1, _var10, _var2, _var3, _var4, _var5, _var6, _var7, _var8, _var9;
    responseArgs = arguments[0];
          ...
          if (_var8 !== null && typeof _var8 !== 'undefined') {
            ...
            _results.push((function() {
              ...
              for (_k = 0, _len2 = _var9.length; _k < _len2; _k++) {
                message2 = _var9[_k];
                if (message2.getBayeuxChannel() === "/meta/bind") {
                  this.addBoundRecords(message2.getRecords());
                  _results1.push(this.raiseServerBind(message2));
                } else {
                  if (message2.getBayeuxChannel() === "/meta/unbind") {
                    this.removeBoundRecords(message2.getRecords());
                    _results1.push(this.raiseServerUnbind(message2));
                  } else {
                    if (message2.getBayeuxChannel() === "/meta/subscribe") {
                      this.addSubscribedChannels(message2.getTag(), message2.getChannels());
                      onReceive = this.raiseServerSubscribe(message2);
                      _var10 = onReceive;
                      if (_var10 === null || typeof _var10 === 'undefined') {
                        throw new Error("ServerBind callback must return a receive-message handler.");
                      }
                      _results1.push(this.addSubscribedOnReceive(message2.getTag(), message2.getChannels(), onReceive, message2.getDynamicProperties()));
                    } else {
                      if (message2.getBayeuxChannel() === "/meta/unsubscribe") {
                        this.removeSubscribedChannels(message2.getTag(), message2.getChannels());
                        this.raiseServerUnsubscribe(message2);
                        _results1.push(this.removeSubscribedOnReceive(message2.getTag(), message2.getChannels()));
                      } else {
...
(function() {
  ...
  fm.websync.client = function() {
    ...
    if (_created && !client.enableMultiple) {
      ...
      c = this;
      return fm.util.observe(window, 'beforeunload', function() {
