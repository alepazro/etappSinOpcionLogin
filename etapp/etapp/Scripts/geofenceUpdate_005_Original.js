...
function saveNewGeofence() {
    try {
        ...
        if (isOk == true) {
            ...
            var url = 'https://etrack.ws/etrack.svc/saveGeofence';
            //url = 'http://localhost:51230/etrack.svc/saveGeofence';
...
function loadGeoMessages() {
    try {
        ...
        $.ajax({
            url: 'https://etrack.ws/etrack.svc/getGeofencesMessages/' + getTokenCookie('ETTK') + '/1',
            type: "GET",
            data: 0,
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
        ...
        $.ajax({
            url: 'https://etrack.ws/etrack.svc/getGeofencesMessages/' + getTokenCookie('ETTK') + '/2',
            type: "GET",
            data: 0,
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
