 ...
 * known as [function currying](https://en.wikipedia.org/wiki/Currying).
 *
 ...
 * `angular.element` can be either an alias for [jQuery](https://api.jquery.com/jQuery/) function, if
 ...
 * - [triggerHandler()](https://api.jquery.com/triggerHandler/) - Doesn't pass native event objects to handlers.
...
function createInjector(modulesToLoad) {
  ...
  function createInternalInjector(cache, factory) {
    ...
    function invoke(fn, self, locals){
      ...
      // Performance optimization: https://jsperf.com/apply-vs-call-vs-invoke
 ...
 * {@link https://dev.w3.org/html5/spec/Overview.html#the-indicated-part-of-the-document Html5 spec}.
 *
...
LocationUrl.prototype = {
   ...
   * {@link https://www.ietf.org/rfc/rfc3986.txt RFC 3986}.
   *
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     * XMLHttpRequest} object or via {@link https://en.wikipedia.org/wiki/JSONP JSONP}.
     *
     ...
     *
     * - {@link https://haacked.com/archive/2008/11/20/anatomy-of-a-subtle-json-vulnerability.aspx
     *   JSON Vulnerability}
     * - {@link https://en.wikipedia.org/wiki/Cross-site_request_forgery XSRF}
     *
     ...
     *
     * A {@link https://haacked.com/archive/2008/11/20/anatomy-of-a-subtle-json-vulnerability.aspx
     * JSON Vulnerability} allows third party web-site to turn your JSON resource URL into
     * {@link https://en.wikipedia.org/wiki/JSON#JSONP JSONP} request under some conditions. To
     ...
     *
     * {@link https://en.wikipedia.org/wiki/Cross-site_request_forgery XSRF} is a technique by which
     ...
     * cookie with {@link https://en.wikipedia.org/wiki/Rainbow_table salt for added security}.
     *
     *
    ...
    if (lowercase(method) == 'jsonp') {
      ...
      xhr.onreadystatechange = function() {
        if (xhr.readyState == 4) {
          ...
          // CORS "simple response headers" https://www.w3.org/TR/cors/
          var value,
...
var inputType = {
   ...
   * @example
      <doc:example>
        ...
        <doc:scenario>
          it('should initialize to model', function() {
            expect(binding('text')).toEqual('https://google.com');
            expect(binding('myForm.input.$valid')).toEqual('true');
          });
 ...
 * {@link https://unicode.org/repos/cldr-tmp/trunk/diff/supplemental/language_plural_rules.html
