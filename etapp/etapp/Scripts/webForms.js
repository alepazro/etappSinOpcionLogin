            ...
            if (promoCode != '') {
                ...
                switch (promoCode) {
                    ...
                    case 'ALLIN':
                        ...
                        promoPriceActivation = 20.00;
                        $("#cbxServices").val("17");
                        $('#orderItemLastMonth').show();
                        $('#specialInstructions').val('Special Conditions: Free unit with 1st, last, and activation.  Minimum commitment: 6 months.')
                        isValid = true;
                        break;
                    case 'NOV50':
                        promoPrice = 59.50;
                        promoPriceService = -0.01;
                        $("#cbxServices").val("17");
                        $('#orderItemFollowingMonths').show();
                        $('#specialInstructions').val('Special Conditions: GPS Tracker 50% off PLUS 1st month free.')
                        isValid = true;
                        break;
                    default:
                        promoPrice = 119;
...
function buyNow() {
    try{
        ...
        if ($('#cbxServices').val() == '17' && (promoCode != 'ALLIN' && promoCode != 'NOV50')) {
            $('#cbxServices').val('13');
        }
    } catch (ex) {
