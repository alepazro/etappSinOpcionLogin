...
and [Commit Message Style Guide](https://wiki.jqueryui.com/w/page/25941597/Commit-Message-Style-Guide).
...
jQuery UI uses the [grunt](https://github.com/cowboy/grunt) build system. Building jQuery UI requires node.js and a command line zip program.
...
When looking at pull requests, first check for [proper commit messages](https://wiki.jqueryui.com/w/page/12137724/Bug-Fixing-Guide).
