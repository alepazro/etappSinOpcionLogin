...
#Region "Authorization"
    ...
    Public Function CredentialsVerification(ByVal UserName As String, ByVal Password As String, ByVal rememberMe As Boolean, ByRef msg As String, ByVal pnewApp As Boolean) As DataView
        Dim IsValid As Boolean = False
        Dim dvData As DataView = Nothing
        Dim dtTable As New DataTable
        ...
        Try
            ...
            strCommand = "CompaniesUsers_ValidateCredentials_NEW"
            conString = ConfigurationManager.AppSettings("ConnectionString")
            conSQL = New SqlConnection(conString)
            Command = New SqlCommand
            Command.Connection = conSQL
            ...
            Dim newApp As New SqlClient.SqlParameter("@newApp", SqlDbType.Bit)
            newApp.Direction = ParameterDirection.Input
            newApp.Value = pnewApp
            Command.Parameters.Add(newApp)
...
#Region "Devices"
    ...
    End Function
    Public Function getDevicesGroups(ByVal Token As String, ByVal groupId As String, ByVal LastFetchOn As Date, ByRef strError As String) As DataSet
        Dim dsData As New DataSet

        Try
            'strCommand = "Devices_GetByToken"
            strCommand = "Devices_GetByToken_Groups"
            conString = ConfigurationManager.AppSettings("ConnectionString")
            conSQL = New SqlConnection(conString)
            Command = New SqlCommand
            Command.Connection = conSQL
...
#Region "Geofences"
    ...
    Public Function getGeofences_All(ByVal Token As String, ByVal isExtended As Boolean, ByRef errMsg As String) As String
        Dim strJson As String = ""
        Dim ListGeofences As List(Of Geofence) = New List(Of Geofence)
        Dim geofence As Geofence
        ...
        Try
            ...
            Do While reader.Read
                geofence = New Geofence With {
                    .id = reader("GUID"),
                    .name = reader("Name"),
                    .fullAddress = reader("FullAddress"),
                    .latitude = reader("Latitude"),
                    .longitude = reader("Longitude"),
                    .radiusFeet = reader("RadiusFeet"),
                    .geofenceAlertTypeName = reader("GeofenceAlertTypeName"),
                    .geofenceTypeName = reader("GeofenceTypeName"),
                    .shapeID = reader("ShapeID")
                }
                If isExtended = True Then
                    geofence.IconURL = reader("IconURL")
                    geofence.geofenceInfoTable = reader("GeofenceInfoTable")
                    geofence.jsonPolyVerticesTXT = reader("jsonPolyVerticesTXT")
            ...
            If (ListGeofences.Count > 0) Then
                strJson = JsonConvert.SerializeObject(ListGeofences)
            End If
            If Not reader.IsClosed Then
                reader.Close()
            End If
...
#Region "Dispatch Jobs "
    ...
    End Function
    Public Function saveWorkOrderNEW(ByVal token As String, ByVal JobNumber As String, ByVal deviceId As String, ByVal driverId As String, ByVal isGeofence As String, ByVal geofenceGUID As String, ByVal name As String, ByVal phone As String, ByVal street As String, ByVal city As String, ByVal state As String, ByVal postalCode As String, ByVal jobDescription As String, ByVal jobAddress As String, ByVal jobMap As String, ByVal lat As Decimal, ByVal lng As Decimal, ByVal sendSMS As Boolean, ByVal smsMessage As String, ByVal via As Integer, ByVal durationHH As Integer, ByVal durationMM As Integer, ByVal dueDate As DateTime, ByVal StartOn As DateTime, ByVal jobpriority As String, ByVal jobcategories As String, ByRef strError As String) As String
        Dim JobGUID As String = ""
        ...
        Try
            ...
            parjobpriority.Value = jobpriority
...
#Region "Maintenance module"
    ...
    Public Function getHServices(ByVal Token As String, ByVal DeviceID As String, ByVal TaskID As Integer,
    ...
    Public Function getHFuel(ByVal Token As String, ByVal DeviceID As String, ByVal dateFrom As Date,
...
#End Region
    ...
    Public Function getTrail2(ByVal token As String, ByVal deviceId As String, ByVal dateFrom As DateTime, ByVal dateTo As DateTime, ByRef strError As String) As DataTable
        ...
        Try
            ...
            conString = ConfigurationManager.AppSettings("ConnectionString")
            'If dateTo.ToUniversalTime < DateAdd(DateInterval.Day, -2, Date.Now.Date) Then
            '    If dateTo.ToUniversalTime < "1/1/2021" Then
            '        conString = ConfigurationManager.AppSettings("HETDB") 'HETDB2020
            '    Else
            '        conString = ConfigurationManager.AppSettings("HETDB1") 'HETDB
            '    End If
            'Else
            '    conString = ConfigurationManager.AppSettings("ConnectionString")
            'End If
    ...
    Public Function getAppFeatures(ByVal token As String, ByVal moduleId As Integer, ByRef strError As String) As String
        ...
        Try
            ...
            For Each drv In dsData.Tables("Features").DefaultView
                ...
                jsonFeature.WritePropertyName("hasbrokerorder")
                jsonFeature.WriteValue(drv.Item("hasbrokerorder"))
            ...
            For Each drv In dsData.Tables("UserPreferences").DefaultView
                ...
                jsonModule.WritePropertyName("ShowGeofencesName")
                jsonModule.WriteValue(drv.Item("ShowGeofencesName"))

                jsonModule.WritePropertyName("ZoomLat")
                jsonModule.WriteValue(drv.Item("ZoomLat"))

                jsonModule.WritePropertyName("ZoomLng")
                jsonModule.WriteValue(drv.Item("ZoomLng"))
    ...
    Public Function GetJobs(ByVal token As String, ByVal statusId As String, ByVal workZoneId As String, ByVal assignedToId As String, ByVal jobNo As String, ByVal custName As String) As List(Of job)
        ...
        Try
            ...
            Do While reader.Read
                ...
                itm.Destination = reader.Item("Destination")
                itm.DeviceId2 = reader.Item("DeviceId2")
                itm.GeofencesTarget = reader.Item("GeofencesTarget")
...
#Region "Fuel Card"
    ...
    Public Function saveFuelLogUpload(ByVal token As String,
                                      ByVal deviceId As String,
                                      ByVal logDate As String,
                                      ByVal logTime As String,
                                      ByVal driver As String,
                                      ByVal street As String,
                                      ByVal city As String,
                                      ByVal state As String,
                                      ByVal zip As String,
                                      ByVal galls As Decimal,
                                      ByVal price As Decimal,
                                      ByVal amt As Decimal,
                                      ByVal cardNumber As String,
                                      ByVal merchantName As String,
                                      ByVal odometer As Decimal,
                                      ByVal lat As Decimal,
                                      ByVal lng As Decimal,
