crmApp.controller('casesController', ['$scope', function ($scope) {
    ...
    var urlService = 'https://pre.etrack.ws/cases.svc';
    $scope.cases = jsonGET(urlService, 'cases', 0, true);
    ...
    $scope.loadBasicTables = function () {
        $scope.basicTables = jsonGET(urlService, 'casesBasicTables', 0, false);
        $scope.technicians = jsonGET(urlService, 'technicians', 0, true);
    };
    ...
    $scope.applyFilters = function () {
        ...
        $scope.cases = jsonPOST(urlService, 'casesFiltered', params);
