crmApp.controller('reportsController', ['$scope', function ($scope) {
    var urlService = 'https://pre.etrack.ws/';
    $scope.filter = {
        reportId: '',
        param1: ''
    }
    ...
    $scope.loadBasicTables = function () {
        $scope.basicTables = jsonGET(urlService+'crm.svc', 'reportsBasicTables', 0, false);
    };
    ...
    $scope.refreshView = function () {
        ...
        $scope.report = jsonPOST(urlService+'crm.svc', 'crmreport', params);
