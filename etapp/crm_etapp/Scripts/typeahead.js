...
!function ($) {
    ...
    Typeahead.prototype = {
        ...
        updater: function (item) {
            //JCO: added option to assign val to hidden field.  idControl
            //JCO: added option to call a function once done. callback
            var itm = _.findWhere(this.ajax.data, { name: item });

            if (this.options.callback) {
                this.options.callback(itm);
            }

            $('#' + this.options.idControl).val(itm.id);
            return item
