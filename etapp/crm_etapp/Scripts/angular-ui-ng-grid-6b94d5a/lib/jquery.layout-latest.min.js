 ...
 * $Rev: 303007 $
 *
 * Copyright (c) 2013 Kevin Dalman (https://allpro.net)
 * Based on work by Fabrizio Balliano (https://www.fabrizioballiano.net)
 *
 * Dual licensed under the GPL (https://www.gnu.org/licenses/gpl.html)
 * and MIT (https://www.opensource.org/licenses/mit-license.php) licenses.
 *
 * SEE: https://layout.jquery-dev.net/LICENSE.txt
 * 
 * Changelog: https://layout.jquery-dev.net/changelog.cfm#1.3.0.rc30.79
 *
 * Docs: https://layout.jquery-dev.net/documentation.html
 * Tips: https://layout.jquery-dev.net/tips.html
 * Help: https://groups.google.com/group/jquery-ui-layout
 */

/* JavaDoc Info: https://code.google.com/closure/compiler/docs/js-for-compiler.html
...
; (function ($) {
    ...
    , _initLayoutElements = function (retry) {
        ...
        if (!$N.is(":visible")) {
            ...
            // SEE: https://layout.jquery-dev.net/samples/test_popup_window.html
...
(function ($) {
     ...
     *
     * @see: https://groups.google.com/group/jquery-ui-layout
     */
    /*
