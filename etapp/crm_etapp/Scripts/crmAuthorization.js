    ...
    try {
        ...
        switch (panelId) {
            ...
            case 6:
                ...
                break
            case 7:
                location.href = 'crmViewTools.html';
                break
...
function loginIntoUser(GUID) {
    try {
        var apiUrl = crmGetUrl();
        window.open(apiUrl+'?' + 'userGUID=' + GUID, target = "_blank");
    }
    catch (err) {
    }
}
        ...
        if (_.isUndefined(t) || _.isNull(t) || t == '' || t == null) {
            ...
            if (data.isOk == true) {
                ...
                if (location.pathname.toLowerCase().indexOf('crmmainpanel.html') == -1 &&
                    ...
                    location.pathname.toLowerCase().indexOf('crmviewtools.html') == -1) {
                    location.href = 'crmMainPanel.html';
                }
                ...
                success: function (xml, textStatus) {
                    if (textStatus == 'success') {
                        ...
                        if (jsonResponse.isValid == true) {
                            ...
                            idDealer = jsonResponse.idDealers;
