...
Public Class deviceDet
    ...
    Public NameSensor1 As String = ""
    Public NameSensor2 As String = ""
    Public NameSensor3 As String = ""
    Public NameSensor4 As String = ""
    Public hasAssignments As Integer = 0
